...
class StepOneForm(Form):
    ...
    email = wtforms.fields.StringField(
                             ...
                             #           'type': 'email'}))
    family = wtforms.fields.StringField(#max_length=50,
                             label='Last name',
                             description='Creator of thesis family or last name')#,
                             #widget=forms.TextInput(
                             #   attrs={'class': 'form-control',
                             #          'data-bind': 'value: familyValue'}))
    freeform_advisor = wtforms.fields.StringField(#max_length=50,
    ...
    given = wtforms.fields.StringField(#max_length=50,
                            label='First name',
...
class StepTwoForm(Form):
    ...
    title = wtforms.fields.StringField(#max_length=225,
                            label='Thesis Title')#,
                            #widget=forms.TextInput(
                            #    attrs={'class':'form-control',
